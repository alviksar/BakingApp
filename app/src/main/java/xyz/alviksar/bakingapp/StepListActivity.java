...
public class StepListActivity extends AppCompatActivity implements StepListFragment.OnStepClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mRecipe != null) {
            ...
            Fragment oldStepListFragment = fragmentManager.findFragmentById(R.id.step_list_fragment);
            if (oldStepListFragment == null) {
                ...
                if (mTwoPane) {
                    ...
                    StepDetailFragment newStepDetailFragment = StepDetailFragment.newInstance(videoUrl, description);
                    StepDetailFragment oldStepDetailFragment = (StepDetailFragment) fragmentManager.findFragmentById(R.id.step_detail_fragment);
